...
abstract class BaseContact extends BaseObject implements Persistent
{
    ...
    public function setContactname($v)
    {
        ...
        if ($this->contactname !== $v) {
            $this->contactname = $v;
            $this->modifiedColumns[] = ContactPeer::CONTACTNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ContactPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ContactPeer::CONTACTNAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContactPeer::CONTACTNAME)) $criteria->add(ContactPeer::CONTACTNAME, $this->contactname);
    ...
    public function setSponsors(PropelCollection $sponsors, PropelPDO $con = null)
    {
        ...
        foreach ($sponsorsToDelete as $sponsorRemoved) {
            $sponsorRemoved->setContact(null);
        }
     ...
     * @return PropelObjectCollection|Sponsor[] List of Sponsor objects
     */
    public function getSponsorsJoinState($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SponsorQuery::create(null, $criteria);
