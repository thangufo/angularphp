...
/**
 * Base static class for performing query and update operations on the 'states' table.
 *
 *
 *
...
abstract class BaseStatePeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (StatePeer::ID, StatePeer::CODE, StatePeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (StatePeer::ID => 0, StatePeer::CODE => 1, StatePeer::NAME => 2, ),
    ...
    /**
     * Method to invalidate the instance pool of all tables related to states
