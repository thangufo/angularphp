...
abstract class BaseContactPeer
{
    ...
    const ADDRESS1 = 'contacts.address1';

    /** the column name for the address2 field */
    const ADDRESS2 = 'contacts.address2';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Phone', 'Contactname', 'Address1', 'Address2', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'phone', 'contactname', 'address1', 'address2', ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID, ContactPeer::EMAIL, ContactPeer::PHONE, ContactPeer::CONTACTNAME, ContactPeer::ADDRESS1, ContactPeer::ADDRESS2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'PHONE', 'CONTACTNAME', 'ADDRESS1', 'ADDRESS2', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'phone', 'contactName', 'address1', 'address2', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Phone' => 2, 'Contactname' => 3, 'Address1' => 4, 'Address2' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'phone' => 2, 'contactname' => 3, 'address1' => 4, 'address2' => 5, ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID => 0, ContactPeer::EMAIL => 1, ContactPeer::PHONE => 2, ContactPeer::CONTACTNAME => 3, ContactPeer::ADDRESS1 => 4, ContactPeer::ADDRESS2 => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'PHONE' => 2, 'CONTACTNAME' => 3, 'ADDRESS1' => 4, 'ADDRESS2' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'phone' => 2, 'contactName' => 3, 'address1' => 4, 'address2' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactPeer::CONTACTNAME);
